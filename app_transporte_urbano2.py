...
st.set_page_config(page_title="Dimensionamiento de Ruta Básica", layout="wide")
...
st.sidebar.image("https://cdn-icons-png.flaticon.com/512/479/479836.png", width=100)
